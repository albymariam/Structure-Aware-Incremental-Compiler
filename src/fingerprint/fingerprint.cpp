...
// Self-contained C++ SHA-256 implementation
...
std::string Fingerprinter::computeSHA256(const std::string& input) {
    SHA256_Impl::SHA256_CTX ctx;
    SHA256_Impl::sha256_init(&ctx);
    SHA256_Impl::sha256_update(&ctx, reinterpret_cast<const uint8_t*>(input.c_str()), input.length());
    uint8_t hash[32];
    SHA256_Impl::sha256_final(&ctx, hash);
